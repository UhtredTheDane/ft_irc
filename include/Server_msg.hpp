...
class Server_msg{
	public:
			...
			void join_msg(User *user, std::string &channel_name);
			void mode_msg(User* user, std::string &channel_name);
			void leave_msg(User* user, std::string &channel_name);
			...
			void err_UnknowedMode(User* user,char c, std::string& channel_name);
